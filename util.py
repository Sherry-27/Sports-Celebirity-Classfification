...
def load_saved_artifacts():
    ...
    with open(r"C:\Users\lenovo\OneDrive\Documents\SportsPersonClassifier\server\artifacts\class_dictionary.json",
              "r") as f:
    ...
    global __model
    if __model is None:
        with open(r"C:\Users\lenovo\OneDrive\Documents\SportsPersonClassifier\server\artifacts\saved_model.pkl", "rb") as f:
...
def get_cropped_image_if_2_eyes(image_path, image_base64_data):
    face_cascade = cv2.CascadeClassifier(r"C:\Users\lenovo\OneDrive\Documents\opencv\haarcascades\haarcascade_frontalface_default.xml")
    eye_cascade = cv2.CascadeClassifier(r"C:\Users\lenovo\OneDrive\Documents\opencv\haarcascades\haarcascade_eye.xml")
